  ...
  var EntitySchema = (function() {
    function EntitySchema(key) {
      ...
      var _options$idAttribute = options.idAttribute,
        ...
        _options$postProcessS = options.postProcessStrategy,
        postProcessStrategy =
          _options$postProcessS === undefined
            ? function(input) {
                return _extends({}, input);
              }
            : _options$postProcessS;
      ...
      return Object.keys(input).reduce(function(output, key, index) {
        ...
        return value !== undefined && value !== null
          ? _extends(
              ...
              (_babelHelpers$extends[key] = _this2.normalizeValue(value, input, key, visit, addEntity)),
              _babelHelpers$extends)
            )
          : output;
      }, {});
