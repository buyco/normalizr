  ...
  var r =
    ...
    s = (function() {
      function t(e) {
        ...
        (this._key = e),
          ...
          (this._processStrategy = y),
          (this._postProcessStrategy = l),
          this.define(n);
      }
      return (
        ...
        (t.prototype.normalize = function(t, e, n, i, o) {
          var u = this,
            c = this._processStrategy(t, e, n);
          return (
            Object.keys(this.schema).forEach(function(t) {
              if (c.hasOwnProperty(t) && 'object' === r(c[t])) {
                var e = u.schema[t];
                c[t] = i(c[t], c, t, e, o);
              }
            }),
            o(this, this._postProcessStrategy(c), t, e, n),
            this.getId(t, e, n)
          );
        }),
    ...
    h = (function() {
      ...
      return (
        ...
        (t.prototype.normalizeValue = function(t, e, n, r, i) {
          var o = this.inferSchema(t, e, n);
          if (!o) return t;
          var u = r(t, e, n, o, i);
          return this.isSingleSchema || null == u ? u : { id: u, schema: this.getSchemaAttribute(t, e, n) };
        }),
    ...
    y = (function(t) {
      ...
      return (
        c(e, t),
        (e.prototype.normalize = function(t, e, n, r, i) {
          return this.normalizeValue(t, e, n, r, i);
        }),
      ...
      return (
        ...
        (e.prototype.normalize = function(t, e, n, r, i) {
          ...
          return Object.keys(t).reduce(function(e, n, c) {
            var a,
              f = t[n];
            return null != f ? u({}, e, (((a = {})[n] = o.normalizeValue(f, t, n, r, i)), a)) : e;
          }, {});
        }),
        (e.prototype.denormalize = function(t, e) {
          var n = this;
    ...
    v = (function(t) {
      ...
      return (
        ...
        (e.prototype.normalize = function(t, e, n, r, i) {
          ...
          return m(t)
            .map(function(t, u) {
              return o.normalizeValue(t, e, n, r, i);
            })
            .filter(function(t) {
              return null != t;
            });
    ...
    j = { Array: v, Entity: s, Object: z, Union: y, Values: p },
    k = function(t) {
      var n = {},
        i = O(t);
