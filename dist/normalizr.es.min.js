...
var _typeof =
  ...
  EntitySchema = (function() {
    ...
    return (
      ...
      (e.prototype.normalize = function(e, t, n, r, i) {
        var o = this,
          a = this._processStrategy(e, t, n);
        return (
          Object.keys(this.schema).forEach(function(e) {
            if (a.hasOwnProperty(e) && 'object' === _typeof(a[e])) {
              var t = o.schema[e];
              a[e] = r(a[e], a, e, t, i);
            }
          }),
          i(this, this._postProcessStrategy(a), e, t, n),
          this.getId(e, t, n)
        );
      }),
  ...
  PolymorphicSchema = (function() {
    ...
    return (
      ...
      (e.prototype.normalizeValue = function(e, t, n, r, i) {
  ...
  UnionSchema = (function(e) {
    ...
    return (
      inherits(t, e),
      (t.prototype.normalize = function(e, t, n, r, i) {
        return this.normalizeValue(e, t, n, r, i);
      }),
    ...
    return (
      ...
      (t.prototype.normalize = function(e, t, n, r, i) {
        ...
        return Object.keys(e).reduce(function(t, n, a) {
          var u,
            c = e[n];
          return null != c ? _extends({}, t, (((u = {})[n] = o.normalizeValue(c, e, n, r, i)), u)) : t;
        }, {});
      }),
      (t.prototype.denormalize = function(e, t) {
        var n = this;
  ...
  normalize = function(e, t, n, r, i, o) {
    return (
      (e = validateSchema(e)),
      getValues(t).map(function(t, a) {
        return i(t, n, r, e, o);
      })
    );
  },
  ...
  ArraySchema = (function(e) {
    ...
    return (
      ...
      (t.prototype.normalize = function(e, t, n, r, i) {
        ...
        return getValues(e)
          .map(function(e, a) {
            return o.normalizeValue(e, t, n, r, i);
          })
          .filter(function(e) {
            return null != e;
          });
  ...
  _normalize = function(e, t, n, r, i, o) {
    var a = _extends({}, t);
    return (
